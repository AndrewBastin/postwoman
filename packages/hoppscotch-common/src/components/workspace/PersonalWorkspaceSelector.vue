...
<div>
  <div class="flex flex-col">
    <HoppSmartItem
        ...
        :info-icon="
          activeWorkspaceInfo?.provider === personalWorkspaceProviderService.providerID
...
const personalWorkspaceProviderService = useService(PersonalWorkspaceProviderService)
...
function selectWorkspace() {
  workspaceService.activeWorkspaceHandle.value = personalWorkspaceProviderService.getPersonalWorkspaceHandle()
}
</script>
